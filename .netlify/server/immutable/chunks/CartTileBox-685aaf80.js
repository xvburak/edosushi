...
var import_index_e7abbe67 = require("./index-e7abbe67.js");
var import_cart_a66d9e56 = require("./cart-a66d9e56.js");
var CartTileBox_svelte_svelte_type_style_lang = "";
const css = {
  code: "button.svelte-1uhhywf{opacity:0.5\n}",
  map: null
};
const CartTileBox = (0, import_index_e7abbe67.c)(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_cart();
  return `<div class="${"w-full text-white leading-tight flex flex-col space-y-6 justify-between border-b p-4 md:border-none md:p-0"}"><div class="${"flex-1 hover:bg-white group rounded-md"}"><div class="${"header mb-4 group group-hover:hidden"}"><h1 class="${"title"}">${(0, import_index_e7abbe67.e)(product.title)}</h1></div>
    ...
    return `${content.produkt ? `<div class="${"flex space-x-2"}"><p>${(0, import_index_e7abbe67.e)(content.ks)}ks</p>
                        <div><p>${(0, import_index_e7abbe67.e)(content.produkt)}</p>
                            <p class="${"opacity-50"}">(${(0, import_index_e7abbe67.e)(content.obsah)})</p></div>
